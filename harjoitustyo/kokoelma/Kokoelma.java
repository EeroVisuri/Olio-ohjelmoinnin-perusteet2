...
public class Kokoelma implements Kokoava <Dokumentti> {
	...
	public OmaLista<Dokumentti> getDokumentit() {
        return dokumentit;
    }
	
	//setteri
	
    public void setDokumentit(OmaLista<Dokumentti> dokumentit) {
    ...
    /*
     * Lisää kokoelmaan uuden dokumentin. Kutsuu OmaListan lisää-metodia. Heittää virheen,
     * jos lisättä dokumentti on null tai sitä ei voi vertailla Comparable-rajapinnan kautta.
     */
    ...
    /*
     * Hakee kokoelmasta dokumentin, jolla on sama tunniste kuin metodin parametrina saatu 
     * kokonaisluku. Jos dokumenttia ei löydy, paluuarvo on null.
     */
